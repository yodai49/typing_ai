...
const ITEM_DATA = [ //4番目の要素には、非売品の仮想価格を設定
    ...
    ["赤の仮面",15,"所属チームがREDの場合、経験値ボーナス*%",[5,7,10]],
    ["青の仮面",15,"所属チームがBLUEの場合、経験値ボーナス*%",[5,7,10]],
    ["黄色の仮面",15,"所属チームがYELLOWの場合、経験値ボーナス*%",[5,7,10]],
    ...
    ["赤の服",30,"所属チームがREDの場合、経験値ボーナス*%",[6,8,10]],
    ["青の服",30,"所属チームがBLUEの場合、経験値ボーナス*%",[6,8,10]],
    ["黄色の服",30,"所属チームがYELLOWの場合、経験値ボーナス*%",[6,8,10]],
    ...
    [["装備なし",0,"装備なし",[0]],//BODY2
    ["赤のバッチ",8,"所属チームがREDの場合、経験値ボーナス*%",[6,8,10]],
    ["青のバッチ",8,"所属チームがBLUEの場合、経験値ボーナス*%",[6,8,10]],
    ["黄色のバッチ",8,"所属チームがYELLOWの場合、経験値ボーナス*%",[6,8,10]],
