...
function drawBody1(myAvator,x1,y1,x2,y2,t,trans){//体を描画
    ...
    var headGrad = ctx2d.createLinearGradient(getDrawPos(x1,x2,0.32),getDrawPos(y1,y2,0.35),getDrawPos(x1,x2,0.68),getDrawPos(y1,y2,0.74));
    ...
    ctx2d.fillRect(getDrawPos(x1,x2,0.32),getDrawPos(y1,y2,0.35),getDrawPos(x1,x2,0.68)-getDrawPos(x1,x2,0.32),getDrawPos(y1,y2,0.742)-getDrawPos(y1,y2,0.35));
}
...
function drawLimbs(myAvator,x1,y1,x2,y2,t,trans){ //手足を描画
    if(myAvator.item[3]==0){//ノーマル
        ctx2d.fillStyle="rgba(191,144,0," + trans + ")";
        ctx2d.fillRect(getDrawPos(x1,x2,0.25),getDrawPos(y1,y2,0.4),getDrawPos(x1,x2,0.32)-getDrawPos(x1,x2,0.25),getDrawPos(y1,y2,0.58)-getDrawPos(y1,y2,0.4));
        ctx2d.fillRect(getDrawPos(x1,x2,0.68),getDrawPos(y1,y2,0.4),getDrawPos(x1,x2,0.76)-getDrawPos(x1,x2,0.69),getDrawPos(y1,y2,0.58)-getDrawPos(y1,y2,0.4));
        ctx2d.fillRect(getDrawPos(x1,x2,0.40),getDrawPos(y1,y2,0.74),getDrawPos(x1,x2,0.48)-getDrawPos(x1,x2,0.40),getDrawPos(y1,y2,0.9)-getDrawPos(y1,y2,0.74));
        ctx2d.fillRect(getDrawPos(x1,x2,0.52),getDrawPos(y1,y2,0.74),getDrawPos(x1,x2,0.6)-getDrawPos(x1,x2,0.52),getDrawPos(y1,y2,0.9)-getDrawPos(y1,y2,0.74));
    }
}
...
function drawAvator(myAvator,x1,y1,x2,y2,t,trans){//アバターを描画する関数
    ...
    ctx2d.fillRect(getDrawPos(x1,x2,0),getDrawPos(y1,y2,0),x2-x1,y2-y1);
